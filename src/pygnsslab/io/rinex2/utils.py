"""
Utility functions for RINEX 2 processing.
"""
...
def is_rinex2_file(filename):
    """
    Check if a file is a RINEX 2 observation file.
    ...
    --------
    bool
        True if the file is a RINEX 2 observation file, False otherwise
    """
    ...
    if ext not in ['.obs', '.o', '.yyo', '.yyO', '.yyN', '.yyG']:
        # Not a standard RINEX 2 observation file extension
        return False
    ...
    try:
        with open(filename, 'r') as f:
            ...
            # Check for RINEX 2 version marker
            for line in header_lines:
                if "RINEX VERSION / TYPE" in line and line.strip().startswith("2"):
                    return True
    except:
...
def find_rinex2_files(directory):
    """
    Find all RINEX 2 observation files in a directory.
    ...
    --------
    list
        List of paths to RINEX 2 observation files
    """
    rinex_files = []
