"""
Metadata handling module for RINEX 2 files.
...
def extract_metadata(rinex_header):
    ...
    metadata = {
        ...
        'firstObsTime': rinex_header.get('firstObsTime'),
        'lastObsTime': rinex_header.get('lastObsTime'),
        'interval': rinex_header.get('interval')
    }
    
    # Convert datetime objects to strings for JSON serialization
    if metadata['firstObsTime']:
        metadata['firstObsTime'] = metadata['firstObsTime'].isoformat()
    if metadata['lastObsTime']:
